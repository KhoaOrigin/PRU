...
public class BossScript : Enemy
{
    ...
    [SerializeField] private BossCameraTrigger cameraTrigger;
    ...
    {
        IAttack[] attackComponents = spawn.GetComponents<IAttack>();
        if (attackComponents.Length == 0)
        {
            Debug.LogWarning($"No IAttack components on {spawn.name}");
    ...
    protected override void Die()
    {
        ...
        if (spawner != null)
        {
            ...
            Debug.Log("Disabled EnemySpawner");
        }
        else
        {
        ...
        // Destroy all Enemy components except this boss
